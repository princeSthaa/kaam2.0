...
function ProductionDemandPlanPageContent() {
  const kind = "customer";
  ...
  if (!selectedSourceId || !sourceDetail) {
    return (
      <>
        <AppHeader pathname="/Production/Customer/CreateCustomer" />
        <PageShell sidebar={<Sidebar section="production" pathname="/Production/Customer/CreateCustomer" />}>
          <div className="pp-page create-customer-wrapper">
...
export default function CreateCustomerPage() {
  return (
    <Suspense fallback={<div className="pp-page text-center py-50">Loading page parameters...</div>}>
      <ProductionDemandPlanPageContent />
    </Suspense>
  );
}
