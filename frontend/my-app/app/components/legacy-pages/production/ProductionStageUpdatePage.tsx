    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-6 pb-24">
      ...
      <div className="bg-white border border-slate-200 p-4 sm:p-6 lg:p-8 rounded-3xl shadow-sm relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-2.5 z-10">
          <a href={`/Production/Plan/Details?id=${planId}`} className="inline-flex items-center gap-2 px-4 py-2 border border-slate-200 text-slate-700 bg-white hover:bg-slate-50 rounded-xl text-sm font-semibold transition-colors shadow-sm">
            <span className="material-symbols-outlined text-[18px]">visibility</span> View Details
          </a>
          <a href="/Production/Index" className="inline-flex items-center gap-2 px-4 py-2 border border-slate-200 text-slate-700 bg-white hover:bg-slate-50 rounded-xl text-sm font-semibold transition-colors shadow-sm">
      ...
      <form method="post" id="stageUpdateForm" className="flex flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4 bg-white border border-slate-200 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-sm">
          ...
          <a href={`/Production/Plan/Details?id=${planId}`} className="inline-flex items-center gap-2 px-5 py-2.5 border border-slate-200 text-slate-600 hover:bg-slate-50 rounded-xl text-sm font-semibold transition-colors">
            Cancel
          </a>
        </div>
      </form>
