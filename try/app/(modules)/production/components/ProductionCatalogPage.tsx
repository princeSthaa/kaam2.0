...
const catalogConfig = {
  customer: {
    ...
    createPlanHref: "/production/demands/customer",
  ...
  outlet: {
    ...
    createPlanHref: "/production/demands/outlet",
      ...
      <div className={`pp-page ${config.pageClass}`}>
        <div className="pp-page-header">
          ...
          <div className="pp-header-actions">
            <ActionButton href="/production/demands">Change Demand Type</ActionButton>
            <ActionButton href="/production">Back to Plans</ActionButton>
          </div>
        </div>
